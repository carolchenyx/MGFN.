...
def parse_args():
    ...
    parser.add_argument('--gt', default='data/ucf_tencrop_1d/gt-ucf-renew.npy', help='file of ground truth ')
    ...
    parser.add_argument('--mhsa_types1', default='gb', help='mhsa_types1')
    parser.add_argument('--mhsa_types2', default='fb', help='mhsa_types2')
    parser.add_argument('--mhsa_types3', default='fb', help='mhsa_types3')
